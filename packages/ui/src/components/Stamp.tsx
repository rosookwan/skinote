...
// delegated 보라 '차량 22:00'. 보냄 대기(오프라인에서 확인한 도장)는 점선 도장이다. 도장 주홍은 늦음 빨강이 아니다.
...
export interface StampProps {
  ...
  /** 'mini'는 모인 칸의 작은 그림, 'word'는 접수증 돈 줄의 글자 도장('수납 끝' · '수납 일부'). */
  size?: StampSize;
...
/**
 * 글자 도장의 글: 상태를 글로 쓴다(그림만으로 끝 · 일부 · 할 일이 갈리지 않게). 할 일은 도장 글자만('수납'),
 * 끝 · 일부 · 예정은 도장 글자 + 상태('수납 끝' · '수납 일부' · '지급 2 / 4' · '수납 예정').
 */
