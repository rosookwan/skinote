...
export const dayLedger: LedgerViewResult = {
  ...
  rows: [
    ...
    orderRow('o28', 23, 0, '윤서준', '0028', [['스키', 2], ['의류', 2]], ['내일 09:00', '솔마을 한솔동'], { alts: ['미수 120,000원', '120,000원'] }, [stamp('issue', 'blocked', { blockedBy: { stepKey: 'ticket_secure', message: '발권 대기' } }), stamp('return', 'na'), stamp('pay', 'todo')]),
...
export const orderSlip: OrderSlip = {
  ...
  checklist: [
    { stepKey: 'order', parts: [{ text: '예약 · 리프트권 105,000원 수납', drop: 0 }], state: 'done', actionKey: 'next_step' },
    ...
    { stepKey: 'return', parts: [{ text: '반납', drop: 0 }, { text: '오늘 22:00', drop: 1 }, { text: '설천 주차장', drop: 2 }, { text: '차량 수거', drop: 3 }], state: 'later', actionKey: 'stamp.return' },
  ],
