...
export const STATUS_DEFAULT_LABELS = {
  order: {
    booked: '예약', cancelled: '취소', awaiting_exchange: '교환 대기', needs_review: '확인 필요', partial_return: '부분 반납',
    in_use: '이용 중', awaiting_shop: '입고 대기', awaiting_load: '차량 적재 대기', awaiting_issue: '지급 대기',
    returned: '반납 완료', completed: '완료',
  },
  line: { todo: '미처리', partial: '부분', done: '완료', na: '해당 없음' },
  task: { waiting: '대기', in_progress: '진행 중', completed: '완료', cancelled: '취소' },
  pay_state: { paid: '수납 완료', partial: '부분 수납', unpaid: '미수', promised: '다른 팀 결제 예정', none: '청구 없음' },
  promise: { active: '유효', superseded: '변경됨', fulfilled: '완료', cancelled: '취소' },
  booking: { unassigned: '강습팀 미정', reserved: '예약', done: '완료', cancelled: '취소', no_show: '불참' },
  stamp: { todo: '미처리', partial: '부분', done: '완료', na: '—', blocked: '대기', scheduled: '예정', delegated: '차량 담당' },
