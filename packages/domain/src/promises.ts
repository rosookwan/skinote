// 반납 일정이 품목 · 수량으로 나뉜 접수(일정 변경 N2, V9 · data-model 4-6 · 4-18)의 셈. 줄마다 일정 몫(bucket)을 나누고,
...
// 화면은 이 셈을 모른다: 읽기 모델(수거 목록 줄 · 접수증 일정 줄 · 처리 현황)만 받는다.
...
export function findTask(state: ShopState, taskId: string): FxTask | undefined {
